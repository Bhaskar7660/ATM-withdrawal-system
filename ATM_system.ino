...
#define WIFI_SSID "TP-Link_A699"
#define WIFI_PASSWORD "17387996"
// Telegram BOT Token (Get from Botfather)
#define BOT_TOKEN "2146829802:AAG4izLs08SvvNjKqR6bIU-vsWKda2bcIJ8"
const char* server = "http://api.thingspeak.com/update";
String apiKey = "ABJNNRELDJSPYC5D";     //  Enter your Write API key from ThingSpeak
